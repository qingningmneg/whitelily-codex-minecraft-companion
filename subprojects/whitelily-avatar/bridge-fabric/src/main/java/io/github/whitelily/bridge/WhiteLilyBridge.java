...
public final class WhiteLilyBridge {
  public static final String WHITE_LILY_USERNAME = "WhiteLily";
  public static final UUID WHITE_LILY_OFFLINE_UUID =
  ...
  public static boolean isCurrentPublishedIntegratedServer(Object candidate) {
